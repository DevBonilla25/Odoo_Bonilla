...
/**
 * Operaciones Logísticas - Frontend Principal
 * =====================================
 *
 * Aplicación principal del frontend de Operaciones Logísticas.
 * Esta es una interfaz básica independiente del POS.
 */
export class LogisticOperationsApp extends Component {
    static template = "logistic_operations.LogisticOperationsApp";
    ...
    async closeSession() {
        ...
        try {
            ...
            window.location = "/web#action=logistic_operations.action_logistic_operations_dashboard";
...
registry.category("actions").add("logistic_operations.ui", LogisticOperationsApp);