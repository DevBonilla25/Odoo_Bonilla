...
/**
 * Cash Opening Popup para Operaciones Logísticas
 * ========================================
 *
...
export class CashOpeningPopup extends Component {
    static template = "logistic_operations.CashOpeningPopup";
    ...
    async confirm() {
        ...
        try {
            ...
            // Redirigir al frontend de Operaciones Logísticas
            window.location = `/logistic_operations/ui?session_id=${this.props.session_id}`;
